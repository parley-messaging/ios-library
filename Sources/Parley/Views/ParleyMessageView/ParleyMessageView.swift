...
final class ParleyMessageView: UIView {
    ...
    private func renderMetaStatus() {
        if message.type == .user {
            ...
            case .failed:
                imageMetaStatusImageView.image = UIImage(named: "ic_close", in: .module, compatibleWith: nil)?
                    .withRenderingMode(.alwaysTemplate)
                statusImageView.image = UIImage(named: "ic_close", in: .module, compatibleWith: nil)?
                    .withRenderingMode(.alwaysTemplate)
            case .pending:
                imageMetaStatusImageView.image = UIImage(named: "ic_clock", in: .module, compatibleWith: nil)?
                    .withRenderingMode(.alwaysTemplate)
                statusImageView.image = UIImage(named: "ic_clock", in: .module, compatibleWith: nil)?
                    .withRenderingMode(.alwaysTemplate)
            case .success:
                imageMetaStatusImageView.image = UIImage(named: "ic_tick", in: .module, compatibleWith: nil)?
                    .withRenderingMode(.alwaysTemplate)
                statusImageView.image = UIImage(named: "ic_tick", in: .module, compatibleWith: nil)?
                    .withRenderingMode(.alwaysTemplate)
            }
        } else {
