...
public class MessageTableViewCellAppearance: ParleyMessageViewAppearance {
    ...
    static func agent() -> MessageTableViewCellAppearance {
        ...
        appearance.balloonImage = UIImage(named: "agent_balloon", in: .module, compatibleWith: nil)?
    ...
    static func user() -> MessageTableViewCellAppearance {
        ...
        appearance.balloonImage = UIImage(named: "user_balloon", in: .module, compatibleWith: nil)?
            .resizableImage(withCapInsets: edgeInsets)
