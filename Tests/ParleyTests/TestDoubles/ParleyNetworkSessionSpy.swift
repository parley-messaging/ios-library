...
public final class ParleyNetworkSessionSpy: ParleyNetworkSession {
    ...
    public var requestMethodParametersHeadersCompletionClosure: ((URL, HTTPRequestMethod, [String: Any]?, [String: String], @escaping (_ result: Result<HTTPDataResponse, HTTPErrorResponse>) -> Void) -> ParleyRequestCancelable)?

    @discardableResult
    public func request(_ url: URL, method: HTTPRequestMethod, parameters: [String: Any]?, headers: [String: String], completion: @escaping (_ result: Result<HTTPDataResponse, HTTPErrorResponse>) -> Void) -> ParleyRequestCancelable {
    ...
    public var uploadDataToMethodHeadersCompletionClosure: ((Data, URL, HTTPRequestMethod, [String: String], @escaping (_ result: Result<HTTPDataResponse, HTTPErrorResponse>) -> Void) -> ParleyRequestCancelable)?

    @discardableResult
    public func upload(data: Data, to url: URL, method: HTTPRequestMethod, headers: [String: String], completion: @escaping (_ result: Result<HTTPDataResponse, HTTPErrorResponse>) -> Void) -> ParleyRequestCancelable {
    ...
    public var uploadDataToMethodHeadersClosure: ((Data, URL, HTTPRequestMethod, [String: String]) -> ParleyRequestCancelable)?

    @discardableResult
    public func upload(data: Data, to url: URL, method: HTTPRequestMethod, headers: [String: String]) -> ParleyRequestCancelable {
