...
public class InfoTableViewCellAppearance {
    ...
    public var regularFont: UIFont = UIFont.systemFont(ofSize: 14)
    public var italicFont: UIFont = UIFont.italicSystemFont(ofSize: 14)
    public var boldFont: UIFont = UIFont.boldSystemFont(ofSize: 14)
