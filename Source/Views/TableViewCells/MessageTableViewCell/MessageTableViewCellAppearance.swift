public class MessageTableViewCellAppearance: ParleyMessageViewAppearance {
    ...
    internal static func agent() -> MessageTableViewCellAppearance {
        ...
        appearance.balloonImage = UIImage(named: "agent_balloon", in: Bundle(for: type(of: appearance)), compatibleWith: nil)?.resizableImage(withCapInsets: edgeInsets)
    ...
    internal static func user() -> MessageTableViewCellAppearance {
        ...
        appearance.balloonImage = UIImage(named: "user_balloon", in: Bundle(for: type(of: appearance)), compatibleWith: nil)?.resizableImage(withCapInsets: edgeInsets)
